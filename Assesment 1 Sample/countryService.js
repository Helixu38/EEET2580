...
const subregionAPI = `https://restcountries.com/v3.1/subregion`
...
function addSubRegion(){
  const subRegionContainer = document.getElementById('sub-region');
  for(let i = 0 ; i < subregionArray; i++){
    const subRegionList = document.createElement('li');
